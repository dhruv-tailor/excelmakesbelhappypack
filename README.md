...
Install instructions: go to  the [Releases](https://github.com/TheDivexz/excelmakesbelhappypack/releases) page and download the latest release.
...
Then unpack the .zip into the mod folder. 
